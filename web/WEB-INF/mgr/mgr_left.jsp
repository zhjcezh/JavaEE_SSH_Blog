...
<ul>
    <li><a href="${pageContext.request.contextPath}/category_list.action?id=<s:property value='#session.curUser.id'/>" target="mainFrame"><i></i>
        分类管理</a></li>
    <li><a href="${pageContext.request.contextPath}/article_pageList.action?id=<s:property value='#session.curUser.id'/>" target="mainFrame"><i></i>文章管理</a></li>
    <li></i><a href="${pageContext.request.contextPath}/user_list.action?username=<s:property value='#session.curUser.username'/>" target="mainFrame"><i></i>用户管理</a></li>
</ul>
