...
<div class="main_top">
    ...
    <form id="blog_form" action="${ctx}/article_add.action" method="post" enctype="multipart/form-data">
        <div class="edit_content">
            ...
            <input type="hidden" name="user.id" value="<s:property value='#session.curUser.id'/>">
            <div class="item1">
                <span>所属分类：</span>
            ...
            <div class="item1">
                <span>附属标签：</span>
                <input type="text" class="am-form-field" name="article_label" id="article_label" style="width: 300px">&nbsp;&nbsp;
            </div>
            <div class="item1">
                <span>文章权限：</span>
                <select id="type_select" name="article_type" style="width: 150px">&nbsp;&nbsp;
